...
public class FeignMetricsInvocationHandlerFactoryDecoratorTest {
    ...
    public void createOnMethodLevelWithAnnotation() throws Exception {
        ...
        feignMetricsInvocationHandlerFactoryDecorator.create(target, dispatch);
        assertEquals("metricRegistry should contain 9 metrics.", 9, metricRegistry.getNames().size());
        assertEquals(Stream.of("com.github.mwiede.metrics.feign.MyClientWithAnnotationOnMethodLevel.myMethod.1xx-responses",
                ...
                "com.github.mwiede.metrics.feign.MyClientWithAnnotationOnMethodLevel.myMethod.Counted",
                "com.github.mwiede.metrics.feign.MyClientWithAnnotationOnMethodLevel.myMethod.exceptions").sorted().collect(Collectors.toList()),
                Stream.of(metricRegistry.getNames().toArray()).sorted().collect(Collectors.toList()));
    }
    ...
    public void createOnClassAndMethodLevelWithAnnotation() throws Exception {
        ...
        feignMetricsInvocationHandlerFactoryDecorator.create(target, dispatch);
        assertEquals("metricRegistry should contain 9 metrics.", 9, metricRegistry.getNames().size());
        assertEquals(Stream.of("com.github.mwiede.metrics.feign.MyClientWithAnnotationOnClassAndMethodLevel.myMethod.1xx-responses",
                ...
                "com.github.mwiede.metrics.feign.MyClientWithAnnotationOnClassAndMethodLevel.myMethod.Counted",
                "com.github.mwiede.metrics.feign.MyClientWithAnnotationOnClassAndMethodLevel.myMethod.exceptions").sorted()
    ...
    public void createOnClassLevelWithAnnotation() throws Exception {
        ...
        feignMetricsInvocationHandlerFactoryDecorator.create(target, dispatch);
        assertEquals("metricRegistry should contain 9 metrics.", 9, metricRegistry.getNames().size());
        assertEquals(Stream.of("com.github.mwiede.metrics.feign.MyClientWithAnnotationOnClassLevel.myMethod.1xx-responses",
                ...
                "com.github.mwiede.metrics.feign.MyClientWithAnnotationOnClassLevel.myMethod.Counted",
                "com.github.mwiede.metrics.feign.MyClientWithAnnotationOnClassLevel.myMethod.exceptions").sorted().collect(Collectors.toList()),
                Stream.of(metricRegistry.getNames().toArray()).sorted().collect(Collectors.toList()));
    }
